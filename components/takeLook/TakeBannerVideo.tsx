...
export default function TakeBannerVideoPlayer({ src, poster, title }: VideoPlayerProps) {
  ...
  return (
    <div className="px-4">
      <div
      className="relative   h-[350px] w-full lg:h-[400px] overflow-hidden rounded-lg shadow-lg bg-black aspect-video group mx-4  "
