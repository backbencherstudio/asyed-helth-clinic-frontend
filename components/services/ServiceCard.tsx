  ...
  return (
    <div>
       <div
            ...
            className={`px-6 py-8 rounded-xl border group bg-whiteColor  duration-300 group
hover:bg-PrimaryColor transition-colors text-secondHeaderColor border-[#EAECF0]
 ...
 <Image src={item.icon} alt={item.title} width={46} height={46} className={`w-full absolute top-0 left-0 ${!ismove ? "opacity-100" : "opacity-0"}` }/>
            ...
            <button
                className={`w-10 h-10 cursor-pointer group-hover:text-whiteColor group-hover:border-0 group-hover:bg-seconderyColor rounded-full flex items-center justify-center mt-12 
