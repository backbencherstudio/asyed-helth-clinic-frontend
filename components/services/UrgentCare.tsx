    ...
    return (
        <section className=' max-w-[82.5rem] mx-auto px-4 xl:px-0 pt-14 lg:pt-32'>
            <div className=" grid grid-cols-1 lg:grid-cols-6 gap-7">
                <div className=" lg:col-span-2 bg-[#E7F4D3] p-8 rounded-2xl flex flex-col justify-around pr-10">
                    <div className=" pr-20 ">
                ...
                <div className=" lg:col-span-4 ">
                    <div className=" w-full h-full overflow-hidden rounded-2xl relative">
                        <Image src={urgentImage} alt="urgentiamge" width={1200} height={400} className=" " />
