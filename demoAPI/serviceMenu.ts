export const categoysubItems = {
  ...
  "Medical Procedures": [
    { title: "Abscess & Cyst Drainage", path: "abscess-cyst-drainage" },
    ...
    { title: "Tick & Foreign Object Removal", path: "tick-foreign-object-removal" },
  ...
  "Kids' Health": [
    ...
    { title: "Pediatric Cold & Flu Care", path: "pediatric-cold-flu-care" },
    { title: "School, Sports, & Camp Physicals", path: "school-sports-camp-physicals" }
  ],
  "IV Therapy": [
  ...
  "Skin & Rashes": [
    { title: "Bug Bites & Rashes", path: "bug-bites-rashes" },
    { title: "Hemorrhoid Treatment", path: "hemorrhoid-treatment" },
    { title: "Wart & Skin Tag Removal", path: "wart-skin-tag-removal" },
    { title: "Athlete's Foot & Fungal Infections", path: "athletes-foot-fungal-infections" }
  ],
  "Vaccines & Shots": [
  ...
  "Physical Exams": [
    ...
    { title: "Employment & Pre-Op Physicals", path: "employment-pre-op-physicals" }
  ],
  "Sexual Health": [
